...
<form action="#" class="withdraw-form amlm-form" id="withdraw-form" method="post">
    ...
    <div class="form-group group-withdraw-amount">
        ...
        <span class="field-info">
            <?php
            if ($amlmEarningMoney) {
                printf(__('Your current balance: <b><span class="currency">%2$s</span> <span class="price">%1$s</span></b>', 'amlm-locale'), round($amlmEarningMoney, 2), get_option('woocommerce_currency'));
            } else {
