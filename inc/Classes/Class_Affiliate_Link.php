...
class Class_Affiliate_Link
{
    ...
    public function register()
    {
        ...
        add_action('woocommerce_thankyou', [$this, 'generateAffiliateSale']);
    }
     ...
     *
     * @param [type] $ref get the ref value from the 
     * 
     * @return void
     */
    ...
    /**
     * Generate the affiliate sale
     *
     * @param integer $order_id requires the order id
     * 
     * @return void
     */
